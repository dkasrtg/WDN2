...
<div id="wrapper">
    ...
    <div class="navbar-custom">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
            ...
            <li>
                <h4 class="page-title-main">AUTHENTICATION</h4>
            </li>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card card-body">
                                <h4 class="card-title">Normal page</h4>
                                <p class="card-text">Accessible for everyone.</p>
                                <a href="/TestFramework/auth1.do" class="btn btn-primary">Go</a>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="card card-body">
                                <h4 class="card-title">Accessible with authenticated</h4>
                                <p class="card-text">Must be authenticated to access.</p>
                                <a href="/TestFramework/auth2.do" class="btn btn-primary">Go</a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card card-body">
                                ...
                                <p class="card-text">Only accessible for admin.</p>
                                <a href="/TestFramework/auth3.do" class="btn btn-primary">Go</a>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="card card-body">
                                <h4 class="card-title">Manager page</h4>
                                <p class="card-text">Only accessible for manager and admin.</p>
                                <a href="/TestFramework/auth4.do" class="btn btn-primary">Go</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- container-fluid -->
