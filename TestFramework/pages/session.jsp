...
<div id="wrapper">
    ...
    <div class="navbar-custom">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
            ...
            <li>
                <h4 class="page-title-main">SESSION</h4>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Session List</h4>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <%
                                                Vector<String[]> vector = (Vector<String[]>) request.getAttribute("sessions");
                                                for (int i = 0; i < vector.size(); i++) {
                                                    out.print("<tr><td>"+vector.get(i)[0]+"</td>\n" +
                                                            "<td>"+vector.get(i)[1]+"</td>\n" +
                                                            "<td><a href=\"/TestFramework/session_delete.do?name="+vector.get(i)[0]+"\"><i class=\"fa fa-trash\"></i></a></td></tr>");
                                                }
                                            %>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">Session Creation</h4>
                                    <form id="demo-form" data-parsley-validate="" action="/TestFramework/session_creation.do" method="post">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input required type="text" id="email" class="form-control" name="value" data-parsley-trigger="change" required="">
                                        </div>
                                        <div>
