            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Updating Dog</h4>
                                <form id="demo-form" data-parsley-validate="" action="/TestFramework/crud_valid_update.do" method="get">
                                    <input type="hidden" name="index" value="<%= request.getAttribute("index")%>">
                                    <div class="mb-3">
                                        <label for="fullname" class="form-label">Name :</label>
                                        <input required type="text" class="form-control" name="name" id="fullname" required="" value="<%= ((Dog)request.getAttribute("dog")).getName()%>">
                                    </div>

                                    <div class="mb-3">
                                        <label for="email" class="form-label">Age :</label>
                                        <input required type="number" id="email" class="form-control" name="age" data-parsley-trigger="change" required="" value="<%= ((Dog)request.getAttribute("dog")).getAge()%>">
                                    </div>
                                    <div>
